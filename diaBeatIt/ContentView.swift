        ...
        VStack {
            Form {
                ...
                Button(action: calculateAverageRealVariability) {
                    Text("Calculate Amputation Risk!")
                }
            }
            
            if !averageRealVariability.isEmpty {
                Text("HgbA1C Variability: \(averageRealVariability)")
                    .padding()
